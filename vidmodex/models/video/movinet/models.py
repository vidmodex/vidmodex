...
class MoViNetA5(MoViNet):
    def __init__(self, causal: bool = True,
                 ...
                 conv_type: str = "3d",
                 tf_like: bool = False):
        super().__init__(_C.MODEL.MoViNetA5, causal, pretrained, num_classes, conv_type, tf_like)
...
class MoViNetA2(MoViNet):
    def __init__(self, causal: bool = True,
                 ...
                 conv_type: str = "3d",
                 tf_like: bool = False):
        super().__init__(_C.MODEL.MoViNetA2, causal, pretrained, num_classes, conv_type, tf_like)