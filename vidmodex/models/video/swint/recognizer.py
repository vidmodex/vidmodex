...
from .head import I3DHead
from .swint import SwinTransformer3D
...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        # else:
        self.neck = None
        self.backbone = backbone # builder.build_backbone(backbone)
    ...
    def forward(self, imgs, label=None, return_loss=False, **kwargs):
        ...
        return self.forward_simple(imgs, **kwargs)
...
class Recognizer3D(BaseRecognizer):
    ...
    def forward_simple(self, imgs, **kwargs):
        """Defines the computation performed at every call when training."""
...
class SwinT(Recognizer3D):
    ...
    def __init__(self, num_classes=400):
        ...
        super().__init__(backbone=backbone, cls_head=cls_head, test_cfg=test_cfg )
